VERSION 5.00
Begin VB.Form frmNewPatientReg1 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "New Patient Registration - I"
   ClientHeight    =   6405
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10800
   ...
   Begin VB.Frame fraPersonal 
      ...
      Begin VB.ComboBox cboSex 
         ...
         DataSource      =   "datPerInfo"
         Height          =   315
         ItemData        =   "frmNewPatientReg.frx":0000
         Left            =   4560
         List            =   "frmNewPatientReg.frx":000A
         TabIndex        =   12
         Text            =   "F"
         Top             =   1080
         Width           =   1695
   ...
   End
End
Attribute VB_Name = "frmNewPatientReg1"
...
With datPerInfo.Recordset
 ...
 ' updates d records into the db
 datPerInfo.Recordset.Update
 datContactInfo.Recordset.Update
 
 MsgBox "New Record Successfully Added.", vbInformation, "Congrats"
 Unload Me
 Exit Sub
errHandler:
...
Private Sub cmdResetForm_Click()
 If MsgBox("Reset form?", vbYesNo, "Confirmation") = vbYes Then Call ClrRegForm1
End Sub

Private Sub Form_Load()
' binds the datacontrols on the form to the db and relative tables b4 loadind form
 ...
 x = datPerInfo.Recordset.Fields("Hospital_No") + 1
 datPerInfo.Recordset.AddNew
 datContactInfo.Recordset.AddNew
 frmNewPatientReg1.txtHospNo.Text = x
 '//
End Sub

Private Sub Form_Unload(Cancel As Integer)
 If MsgBox("You are attempting to cancel registration. All unsaved information will be lost. Do you really want to cancel this registration?" _
            , vbYesNo + vbCritical, "Cancel Registration?") = vbYes Then
    Cancel = 0
 Else
    Cancel = 1
    txtSName.SetFocus

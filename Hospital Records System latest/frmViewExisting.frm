VERSION 5.00
Begin VB.Form frmViewExisting 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "View Patient Record"
   ClientHeight    =   6405
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10860
   ...
   End
End
Attribute VB_Name = "frmViewExisting"
...
Private Sub datPatientInfo1_Validate(Action As Integer, Save As Integer)
'displays current record position and total no. of records

 Dim curRec As Integer, totRecs As Integer
 Dim thisRec As Integer
 picRecCount.Cls
 curRec = datPatientInfo1.Recordset.Bookmark
 totRecs = datPatientInfo1.Recordset.RecordCount
 picRecCount.Print "Record "; curRec; " of "; totRecs
